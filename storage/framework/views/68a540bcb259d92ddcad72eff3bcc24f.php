            ...
            <div class="p-4 bg-white shadow-sm sm:p-8 sm:rounded-lg"> 
                <div class="max-w-xl"> 
                    <section> 
                        ...
                        <form class="mt-6" id="formPeriksa" action="<?php echo e(route('dokter.memeriksa.update', $janjiPeriksa->id)); ?>" method="POST"> 
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="mb-3 form-group"> 
                                ...
                                <input type="datetime-local" class="rounded form-control" id="tgl_periksa" 
                                    name="tgl_periksa" value="<?php echo e($janjiPeriksa->periksa->tgl_periksa); ?>" required> 
                            </div> 
 
                            <div class="mb-3 form-group"> 
                                <label for="catatan">Catatan</label> 
                                <textarea class="rounded form-control" id="catatan" name="catatan" rows="3" placeholder="Catatan pemeriksaan"><?php echo e($janjiPeriksa->periksa->catatan); ?></textarea>
                            </div> 
                                ...
                                <select class="rounded form-control" id="obat" name="obat[]" multiple onchange="hitungBiaya()">
                                    <?php $__currentLoopData = $obats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $obat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                        <option value="<?php echo e($obat->id); ?>"
                                            data-harga="<?php echo e($obat->harga); ?>"
                                            <?php echo e(in_array($obat->id, $selectedObatIds ?? []) ? 'selected' : ''); ?>>
                        ...
                        <script>
                            ...
                            // Pastikan DOM sudah dimuat sebelum fungsi dijalankan
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\laravel\bimkar-hospital\resources\views/dokter/memeriksa/edit.blade.php ENDPATH**/ ?>